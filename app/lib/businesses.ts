...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    description:
      "An 18-hole semi-private course just outside Waconia with rolling fairways and views toward Lake Waconia. Pro shop, full clubhouse with the Green Fox Grille restaurant, leagues, and event hosting.",
    address: "7795 Laketown Parkway, Waconia, MN 55387",
    lat: 44.8632,
    lng: -93.7549,
    phone: "(952) 442-6116",
  ...
  },
  {
    ...
    description:
      "The county's history museum and archives — Dakota and early settler artifacts, Coney Island of Lake Waconia ephemera, agricultural history, and changing exhibits. Small admission, large local context. The Society also runs the Historic Andrew Peterson Farmstead, which hosts the free Fall on the Farm event each September.",
    ...
    tips: [
      ...
      { title: "Fall on the Farm", description: "Their Andrew Peterson Farmstead hosts this free family event every late September — farmyard animals and open-hearth cooking demos." },
    ],
    whatToExpect: {
  ...
  {
    slug: "d-vincis-restaurant",
    name: "D'Vinci's Restaurant",
    category: "DINING",
    ...
    description:
      "Waconia's longtime Italian standby, family-run since 1986. Pizza, pasta, sandwiches, and subs in a casual dining room that's fed the same families for two generations.",
    address: "540 S Elm St, Waconia, MN 55387",
    lat: 44.8443,
    lng: -93.7863,
    phone: "",
    website: "dvinciswaconia.com",
    hours: HOURS_VARIES,
    tips: [
      { title: "Sunday–Thursday Close Earlier", description: "Open 11am–9:30pm Sun–Thu, 11am–10pm Fri–Sat — plan a late dinner for the weekend." },
      { title: "Pizza to Go", description: "Carry-out pizza is a Waconia weeknight staple — call ahead on Fridays." },
      { title: "Family Portions", description: "Sub and pasta portions run generous — good for splitting or leftovers." },
    ],
    whatToExpect: {
      atmosphere: "Casual, family-run Italian dining room",
      crowd: "Multi-generational families, regulars",
      liveEvents: "N/A",
      outdoorSeating: "No",
    },
  ...
  },
  {
    ...
    description:
      "A downtown favorite since 2022 — artisan wood-fired pizza and craft cocktails in a stylish dining room. Consistently ranked among Waconia's top restaurants. Shares its building with The Brass Hat, its attached speakeasy bar.",
    address: "125 W 1st St, Waconia, MN 55387",
    lat: 44.8493,
    lng: -93.7881,
    phone: "",
    website: "bodegrays.com",
    hours: HOURS_VARIES,
    tips: [
      { title: "Reserve for Weekends", description: "Friday and Saturday tables book up — reserve through Tock." },
      { title: "Artisan Pizza", description: "Wood-fired pizza is the signature — worth ordering even alongside other entrees." },
      { title: "Check Out The Brass Hat", description: "The attached speakeasy is a natural after-dinner stop." },
    ],
    whatToExpect: {
      atmosphere: "Stylish, upscale-casual downtown dining room",
      crowd: "Date nights, downtown diners",
      liveEvents: "Occasional themed nights (movie nights, lounge events)",
      outdoorSeating: "No",
    },
  ...
  },
  {
    ...
    description:
      "A speakeasy-style cocktail bar attached to Bode Gray's in downtown Waconia. Craft cocktails and a moody, intimate lounge atmosphere — the closest thing Waconia has to a proper speakeasy.",
    address: "125 W 1st St, Waconia, MN 55387",
    lat: 44.8493,
    lng: -93.7881,
    phone: "(952) 444-0795",
    ...
    hours: HOURS_VARIES,
    tips: [
      { title: "Pair with Dinner", description: "Enter through Bode Gray's — a natural nightcap after dinner next door." },
      { title: "Themed Nights", description: "Watch for special one-off events like movie nights and lounge parties." },
      { title: "Small Space", description: "Intimate room — arrive early on weekends for seating." },
    ],
    whatToExpect: {
      atmosphere: "Moody, intimate speakeasy lounge",
      crowd: "Couples, cocktail enthusiasts",
      liveEvents: "Occasional themed nights",
      outdoorSeating: "No",
    },
    image: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=800&q=80",
  },
  {
    slug: "green-fox-grille",
    name: "Green Fox Grille",
    category: "DINING",
    ...
    description:
      "The clubhouse restaurant at Island View Golf Club — custom-blend burgers, hand-crafted sandwiches, tap beer, and seasonal cocktails. Open to the public, not just golfers, with a deck overlooking Lake Waconia and the course, plus indoor seating down the 18th fairway. Also books weddings and private events.",
    address: "7795 Laketown Parkway, Waconia, MN 55387",
    lat: 44.8632,
    lng: -93.7549,
    phone: "(952) 442-6116",
    website: "islandviewgolfclub.com/clubhouse",
    hours: HOURS_VARIES,
    tips: [
      { title: "Open to Non-Golfers", description: "You don't need to play a round — the grille and deck are open to the public." },
      { title: "Deck Seating in Summer", description: "The outdoor deck overlooking the lake and course is the draw — request it when you arrive." },
      { title: "Event Booking", description: "Available for weddings, private groups, and corporate events — inquire through the golf club." },
    ],
    whatToExpect: {
      atmosphere: "Casual clubhouse grille with lake and fairway views",
      crowd: "Golfers, families, event guests",
      liveEvents: "Private events and weddings",
      outdoorSeating: "Yes — deck overlooking Lake Waconia",
    },
    image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80",
  },
  {
    slug: "culvers-waconia",
    name: "Culver's",
    category: "DINING",
    ...
    description:
      "The Waconia location of the Wisconsin-founded chain — ButterBurgers, cheese curds, and fresh frozen custard with a rotating Flavor of the Day. Fast, reliable, and kid-friendly.",
    address: "10710 W Tenth St, Waconia, MN 55387",
    lat: 44.8392,
    lng: -93.7959,
    phone: "(952) 442-4471",
    website: "culvers.com",
    ...
    tips: [
      { title: "Check the Flavor of the Day", description: "Frozen custard flavor rotates daily — check the app or sign before you order." },
      { title: "Drive-Thru Moves Fast", description: "The drive-thru line looks long but turns over quickly." },
      { title: "Cheese Curds", description: "Wisconsin-style cheese curds are the go-to appetizer." },
    ],
    whatToExpect: {
      atmosphere: "Bright, casual fast-food dining room",
      crowd: "Families, quick lunch and dinner stops",
      liveEvents: "N/A",
      outdoorSeating: "Seasonal patio",
    },
  ...
  },
  {
    ...
    description:
      "The Minnesota-founded coffee chain has two locations in Waconia — the Marketplace Drive café and a second location at 77 State Hwy 5 West. Espresso, cold brew, and baked goods with reliable drive-thru service at both.",
    ...
    hours: [
      { day: "Monday", hours: "5am–8pm" },
      { day: "Tuesday", hours: "5am–8pm" },
      { day: "Wednesday", hours: "5am–8pm" },
      { day: "Thursday", hours: "5am–8pm" },
      { day: "Friday", hours: "5am–8pm" },
      { day: "Saturday", hours: "5:30am–8pm" },
      { day: "Sunday", hours: "5:30am–8pm" },
    ],
    tips: [
      { title: "Two Locations", description: "Marketplace Drive and Hwy 5 West both have drive-thru — check the app for the shorter line." },
      { title: "Mobile Order", description: "Order ahead in the app to skip the counter line." },
      { title: "Caribou Cash", description: "The rewards program stacks free drinks quickly for regulars." },
    ],
    whatToExpect: {
      atmosphere: "Bright, quick-service coffeehouse",
      crowd: "Commuters, families, remote workers",
      liveEvents: "N/A",
      outdoorSeating: "Seasonal patio at some locations",
    },
