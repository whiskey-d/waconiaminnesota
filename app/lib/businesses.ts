...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    longDescription:
      "Waconia has quietly become one of the strongest craft beverage clusters in the western Twin Cities: Schram Vineyards Winery & Brewery on the rolling farmland west of town, Sovereign Estate Wine on Lake Waconia itself, Parley Lake Winery on a working orchard farmstead, and J. Carver Distillery rounding out the spirits side. (Downtown's Waconia Brewing Co. closed in early 2026 — the cluster's center of gravity now sits in the countryside.)",
  },
  {
    slug: "things-to-do",
    label: "Things to Do",
...
export const businesses: Business[] = [
  ...
  {
    slug: "parley-lake-winery",
    name: "Parley Lake Winery",
    category: "BARS",
    ...
    description:
      "A seasonal farm winery sharing an 1888 farmstead with Deardorff Orchards west of Waconia. Estate wines from cold-climate Minnesota grapes, a tasting room with a wrap-around deck overlooking the Lake View Stage and Itasca vineyard, an art gallery featuring local artists, and live music in season. Open seasonally, roughly May through December — peak atmosphere is apple season, when the orchard next door is in full swing.",
    address: "8280 Parley Lake Rd, Waconia, MN 55387",
    lat: 44.876,
    lng: -93.822,
    phone: "",
    website: "parleylakewinery.com",
    hours: HOURS_VARIES,
    tips: [
      { title: "Pair with Apple Picking", description: "Deardorff Orchards is on the same farm — pick apples first, then finish with a glass on the deck." },
      { title: "Seasonal Hours", description: "Open weekends roughly May–December; days and hours shift with the season. Check the website before driving out." },
      { title: "Groups of 10+", description: "Email ahead for larger groups — the tasting room handles them, but they like notice." },
    ],
    whatToExpect: {
      atmosphere: "Rustic farm winery with vineyard views",
      crowd: "Orchard day-trippers, wine club regulars",
      liveEvents: "Live music on the Lake View Stage in season",
      outdoorSeating: "Wrap-around deck overlooking the vineyard",
    },
  ...
  {
    slug: "deardorff-orchards",
    name: "Deardorff Orchards & Vineyards",
    ...
    description:
      "A working family farm dating to 1888, with more than 3,000 apple trees across 120 acres growing Minnesota varieties — SweeTango, Zestar!, Honeycrisp, and Haralson. Open seasonally from around Labor Day weekend until the trees are picked out (typically late October), with complimentary tractor rides for pickers, pumpkins, mums, and local honey in the farm stand. Parley Lake Winery pours estate wine on the same farmstead.",
    address: "8282 Parley Lake Rd, Waconia, MN 55387",
    lat: 44.8762,
    lng: -93.8205,
    phone: "",
    website: "deardorfforchards.com",
    hours: HOURS_VARIES,
    tips: [
      { title: "Go Early for SweeTango", description: "The most popular varieties pick out fast — early-to-mid September is prime SweeTango and Zestar! window." },
      { title: "Check Before You Drive", description: "Open days and picking availability shift week to week with the crop. Confirm on the website or socials." },
      { title: "Make It a Double Stop", description: "Parley Lake Winery is on the same farm — apples for the kids, a tasting for the adults." },
    ],
    whatToExpect: {
      atmosphere: "Working farm, classic Minnesota fall outing",
      crowd: "Families, fall day-trippers",
      liveEvents: "Seasonal fall weekends",
      outdoorSeating: "Farmyard picnic areas",
    },
