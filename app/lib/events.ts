...
export const events: Event[] = [
  ...
  {
    slug: 'art-wander-2026',
    title: 'Edge of the Big Woods Art Wander',
    date: 'September 25–27, 2026',
    dateSort: '2026-09-25',
    endDateSort: '2026-09-27',
    recurring: true,
    recurringNote: 'Annual — the last weekend of September',
    recurrencePattern: 'annual',
    venue: 'Studios across Carver County, including Waconia',
    address: 'Waconia, MN 55387',
    description: 'A self-guided studio tour across Carver County — over 15 art studios and 40+ artists, including stops in Waconia.',
    longDescription: "The Edge of the Big Woods Art Wander is a self-guided studio tour presented by the Arts Consortium of Carver County, now in its 15th year. Over the last weekend of September, more than 15 art studios and over 40 artists across Waconia, Watertown, Chanhassen, Chaska, and Mayer open their doors — potters, weavers, painters, glass artists, woodworkers, sculptors, and jewelers demonstrating their techniques and selling work directly. It's free to attend and self-paced: pick a route, stop at as many or as few studios as you like, and meet the artists behind the work. Check artwander.com for the current year's participating studio map before you go.",
    image: '/images/event-acoustic-sessions.webp',
    category: 'Community',
    free: true,
    ...
    highlights: [
      ...
      'Meet potters, weavers, painters, glass artists, woodworkers, and jewelers',
      'Free to attend',
      'Last weekend of September, including Waconia stops',
    ],
  },
  {
    slug: 'fall-on-the-farm-2026',
    ...
    endTime: '15:00',
    recurring: true,
    recurringNote: 'Annual — late September',
    recurrencePattern: 'annual',
    venue: 'Historic Andrew Peterson Farmstead',
    address: 'Waconia, MN 55387',
    description: 'A free family day at the Historic Andrew Peterson Farmstead — farmyard animals, outdoor cooking demonstrations, and a look at 19th-century farm life.',
    longDescription: "Fall on the Farm brings families out to the Historic Andrew Peterson Farmstead, a preserved 19th-century farm site maintained by the Carver County Historical Society. The free event features farmyard animals, outdoor open-hearth cooking demonstrations, and hands-on activities that give kids a feel for what farm life looked like in territorial-era Minnesota. It pairs naturally with a stop at the Historical Society's museum in downtown Waconia for the fuller local-history picture.",
    image: '/images/event-harvest-festival.webp',
    category: 'Community',
    free: true,
    attendees: 300,
    highlights: [
      ...
      'Run by the Carver County Historical Society',
      'Free admission',
      'Pairs well with the Historical Society museum downtown',
    ],
  },
  {
  ...
  {
    slug: 'pink-friday-2026',
    title: 'Pink Friday Shopping',
    date: 'November 20, 2026',
    dateSort: '2026-11-20',
    startTime: '09:00',
    endTime: '17:00',
    recurring: true,
    recurringNote: 'Annual — the Friday before Black Friday',
    recurrencePattern: 'annual',
    venue: 'Downtown Waconia',
    address: 'Downtown Waconia, MN 55387',
    description: 'A nationwide shop-small day, the Friday before Black Friday — specials at downtown Waconia boutiques and shops.',
    longDescription: "Pink Friday is a nationwide shop-small event held the Friday before Black Friday, and downtown Waconia's boutiques and shops join in with special promotions for the day. It's a lower-key alternative to Black Friday crowds — support local shops before the holiday rush hits the big-box stores. Pair it with D.E.A.R. Hunting Day earlier in November and Small Business Saturday the week after, and you can do most of your holiday shopping without leaving downtown Waconia.",
    image: '/images/event-acoustic-sessions.webp',
    category: 'Community',
    free: true,
    attendees: 300,
    highlights: [
      ...
      'Part of the nationwide shop-small Pink Friday movement',
      'Pairs with D.E.A.R. Hunting Day and Small Business Saturday',
    ],
  },
  {
